...
def get_orchestrateur() -> OrchestratorAgent:
    """
    Accès public à l'instance singleton de l'orchestrateur.
    Utilisé par app.py pour appeler des méthodes directes (ex: mode terrain GPS).
    """
    return _get_orchestrateur()
